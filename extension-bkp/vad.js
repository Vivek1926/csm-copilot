...
export class VAD {
  ...
  constructor({ sampleRate = 16000, onSpeechStart, onSegment } = {}) {
    ...
    // Tunables
    this.minThreshold = 0.008;    // absolute RMS floor for "speech"
    this.noiseMultiplier = 3.0;   // speech must exceed noiseFloor * this
    ...
    this.minSpeechMs = 400;       // discard blips shorter than this
